...
Tudo começou com a ideia de unir o "Sol" (Soluções) com uma estética de "Builder". O primeiro rascunho explorou o formato através de *pixel art*, estabelecendo a geometria base de um círculo central com raios triangulares.

![Rascunho Inicial](./assets/rascunho.png)
...
* **Sky Tech (#8fd3ff)**: Confiança e tecnologia.
* **Solar Gold (#f9c22b)**: Energia e resolução de problemas.

![Estudo de Paleta e Vetorização](./assets/rascunhopaleta.png)
